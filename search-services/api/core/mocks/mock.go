...
type MockAAA struct {
	ctrl     *gomock.Controller
	recorder *MockAAAMockRecorder
	isgomock struct{}
}

// MockAAAMockRecorder is the mock recorder for MockAAA.
type MockAAAMockRecorder struct {
	mock *MockAAA
}

// NewMockAAA creates a new mock instance.
func NewMockAAA(ctrl *gomock.Controller) *MockAAA {
	mock := &MockAAA{ctrl: ctrl}
	mock.recorder = &MockAAAMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockAAA) EXPECT() *MockAAAMockRecorder {
	return m.recorder
}

// Login mocks base method.
func (m *MockAAA) Login(name, password string) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAAAMockRecorder) Login(name, password any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Login", reflect.TypeOf((*MockAAA)(nil).Login), name, password)
}

// Verify mocks base method.
func (m *MockAAA) Verify(tokenString string) error {
	m.ctrl.T.Helper()
...
func (mr *MockAAAMockRecorder) Verify(tokenString any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Verify", reflect.TypeOf((*MockAAA)(nil).Verify), tokenString)
}
